...
%% ------------------------ TYTUL PRACY --------------------------------------
{\bf\large{
Vivado HLS jako nowoczesne narzędzie wspierające tworzenie wyspecjalizowanych układów elektronicznych na przykładzie akceleratora realistycznej grafiki trójwymiarowej czasu rzeczywistego metodą ray tracingu
}}\\
\vspace{14ex}
%% ------------------------ OPIEKUN PRACY ------------------------------------
...
{\bf Vivado HLS jako nowoczesne narzędzie wspierające tworzenie wyspecjalizowanych układów elektronicznych na przykładzie akceleratora realistycznej grafiki trójwymiarowej czasu rzeczywistego metodą ray tracingu}\\
