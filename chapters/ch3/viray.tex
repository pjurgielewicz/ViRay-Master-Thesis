...
\addimage{chapters/ch3/img/instruction.png}{scale=0.43}{Rozmieszczenie bitów danych opisujących podinstrukcję w stworzonym procesorze}{Rozmieszczenie bitów danych opisujących podinstrukcję w stworzonym procesorze}{ch3:img:instruction}
\begin{itemize}
...
\begin{figure}[H]
\centering
\subfigure{\includegraphics[width=0.75\textwidth]{chapters/ch3/img/float_half/output_refl_full.png}}
\subfigure{\includegraphics[width=0.75\textwidth]{chapters/ch3/img/float_half/output_refl_half.png}}
