...
\begin{figure}[H]
\centering
\subfigure{\includegraphics[width=0.85\textwidth]{chapters/ch3/img/float_half/output_refl_full.png}}
\subfigure{\includegraphics[width=0.85\textwidth]{chapters/ch3/img/float_half/output_refl_half.png}}
