...
\addimage{chapters/ch2/img/clock_sync.png}{scale=0.8}{Czas konfiguracji i okres wstrzymania - $t_s$ oraz $t_h$ definiują tzw. okno czasowe, w którym sygnał musi być stabilny aby układ FPGA poprawnie realizował powierzone mu zadanie przetwarzania danych. Synchronizacja następuje względem narastającego zbocza sygnału zegarowego}{Czas konfiguracji i okres wstrzymania}{ch2:img:clock_sync}
