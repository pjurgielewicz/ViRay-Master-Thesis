...
\addimage{chapters/ch1/img/spheres.png}{scale=0.5}{Triangulacja obiektów na przykładzie sfery - im więcej podziałów powierzchni tym gładszy obiekt, jednak czas renderowania dłuższy}{Triangulacja obiektów na przykładzie sfery}{ch1:img:shpereTriangulation}
...
\addimage{chapters/ch1/img/cose.png}{scale=0.5}{Zależność funkcji rozbłysku od parametru skupienia $e$. Im większa wartość $e$ tym rozkład staje się mocniej skupiony wokół $\alpha=0^\circ$}{Zależność funkcji rozbłysku od parametru skupienia $e$}{ch1:img:cose}
